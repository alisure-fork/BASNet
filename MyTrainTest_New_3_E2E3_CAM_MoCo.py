...
class BASNet(nn.Module):
    ...
    def __init__(self, clustering_num=None, is_supervised_pre_train=False, is_unsupervised_pre_train=True,
                 unsupervised_pre_train_path="./pre_model/MoCov2.pth",
                 unsupervised_pre_train_mic_path="./pre_model/MIC4.t7"):
        ...
        if is_unsupervised_pre_train:
            ...
            backbone = self.load_unsupervised_pre_mic_train(backbone, unsupervised_pre_train_mic_path)
    ...
    @staticmethod
    def load_unsupervised_pre_mic_train(model, pre_train_path, change_key="module.backbone."):
        pre_train = torch.load(pre_train_path)["net"]
...
class BASRunner(object):
    ...
    def __init__(self, model_dir, clustering_num, clustering_ratio, img_name_list, lbl_name_list,
                 cam_label_dir, his_label_dir, cam_label_name,
                 mic_size_train, data_name_list, is_unsupervised_pre_train=True,
                 has_f_loss=False, has_crf=False, mic_batch_size=8, sod_batch_size=8,
        ...
        # Model
        self.net = BASNet(clustering_num, is_unsupervised_pre_train=is_unsupervised_pre_train)
...
def train(mic_batch_size, sod_batch_size):
    ...
    save_root_dir = "../BASNetTemp_E2E3/{}_MoCo".format(data_name_list[0])
    cam_label_dir = "{}/cam/CAM_{}_{}_A{}".format(save_root_dir, mic_size_train, size_cam, multi_num)
    name_model = "E2E_R50_3{}_{}_{}{}{}{}{}_{}_{}".format(
    ...
    bas_runner = BASRunner(
        ...
        is_unsupervised_pre_train=is_unsupervised_pre_train, multi_num=multi_num, label_a=label_a, label_b=label_b)
