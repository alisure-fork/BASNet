...
from src.MyTrain_MIC5_Decoder4 import BASNet, DatasetUSOD


def one_decoder():
    # --------- 1. get path ---------
    has_mask = True
    model_dir = './saved_models/my_train_mic5_decoder4_aug_mask/110_train_1.734.pth'
    prediction_dir = Tools.new_dir('./test_data/my_train_mic5_decoder4_aug_mask_110_image_decoder')
    # model_dir = './saved_models/my_train_mic5_decoder4_aug_mask_1/105_train_1.813.pth'
    # prediction_dir = Tools.new_dir('./test_data/my_train_mic5_decoder4_aug_mask_1_105_image_decoder')
