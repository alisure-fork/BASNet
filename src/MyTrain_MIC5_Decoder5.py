...
class BASNet(nn.Module):
    ...
    def forward(self, x):
        ...
        label = self.salient_map_divide(cam_norm_up, obj_th=0.80, bg_th=0.15)  # 显著图划分：Salient Map Divide
...
if __name__ == '__main__':
    ...
    bas_runner = BASRunner(batch_size_train=10, has_mask=True,
                           model_dir="./saved_models/my_train_mic5_decoder5_aug_mask_1_small")
