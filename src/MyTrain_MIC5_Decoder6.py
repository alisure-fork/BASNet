...
class BASRunner(object):
    ...
    def all_loss_fusion(self, mic_1_out, mic_2_out, mic_3_out,
        ...
        loss_all = (loss_mic_1 + loss_mic_2 + loss_mic_3) / 3 + 10 * loss_bce
...
if __name__ == '__main__':
    ...
    bas_runner = BASRunner(batch_size_train=10, has_mask=True, more_obj=True,
                           model_dir="./saved_models/my_train_mic5_decoder6_aug_mask_norm_small_moreobj_10bce")
