...
def one_5():
    ...
    # --------- 1. get path ---------
    model_dir = './saved_models/my_mic_123_diff_automask/usod_175_train_2.628.pth'
    prediction_dir = Tools.new_dir('./test_data/my_mic_123_diff_automask_175_image')
...
def one_1_3():
    # --------- 1. get path ---------
    model_dir = './saved_models/my_mic_123_diff_automask/usod_175_train_2.628.pth'
    prediction_dir = Tools.new_dir('./test_data/my_mic_123_diff_automask_175_image2')
