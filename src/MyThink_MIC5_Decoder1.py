...
from src.MyTrain_MIC5_Decoder1 import BASNet, DatasetUSOD
...
def one_fusion():
    ...
    has_mask = True
    model_dir = './saved_models/my_train5_diff_aug_mask/125_train_6.569.pth'
    prediction_dir = Tools.new_dir('./test_data/my_train5_diff_aug_mask_125_image_fusion')
    # has_mask = False
    # model_dir = './saved_models/my_train5_diff_aug_nomask/125_train_6.044.pth'
    # prediction_dir = Tools.new_dir('./test_data/my_train5_diff_aug_nomask_125_image_fusion')
