...
class DatasetUSOD(Dataset):
    ...
    def __init__(self, img_name_list, lab_name_list, cam_lbl_name_list,
                 his_1_lbl_name_list, his_2_lbl_name_list, size_train=224):
        self.img_name_list = img_name_list
        self.tra_lab_name_list = lab_name_list
        self.cam_lbl_name_list = cam_lbl_name_list
        self.his_1_lbl_name_list = his_1_lbl_name_list
        self.his_2_lbl_name_list = his_2_lbl_name_list
        ...
        self.lbl_name_list_for_save = None
    ...
    def set_change(self):
        Tools.print("DatasetUSOD set_change")
        _train = self.lbl_name_list_for_train
        self.lbl_name_list_for_train = self.lbl_name_list_for_save
        self.lbl_name_list_for_save = _train
        pass
    ...
    def set_label(self, is_supervised, cam_for_train=True):
        ...
        if is_supervised:
            ...
            self.lbl_name_list_for_save = self.his_1_lbl_name_list
        else:
            if cam_for_train:
                self.lbl_name_list_for_train = self.cam_lbl_name_list
                self.lbl_name_list_for_save = self.his_1_lbl_name_list
            else:
                self.lbl_name_list_for_train = self.his_1_lbl_name_list
...
class BASRunner(object):
    ...
    def __init__(self, batch_size=8, size_train=224, size_test=256,
        ...
        (self.img_name_list, self.lbl_name_list, self.cam_lbl_name_list, self.his_1_lbl_name_list,
         self.his_2_lbl_name_list) = self.get_tra_img_label_name(tra_image_dir, tra_label_dir,
        ...
        self.dataset_sod = DatasetUSOD(img_name_list=self.img_name_list, lab_name_list=self.lbl_name_list,
                                       ...
                                       his_1_lbl_name_list=self.his_1_lbl_name_list,
                                       his_2_lbl_name_list=self.his_2_lbl_name_list, size_train=self.size_train)
    ...
    def get_tra_img_label_name(self, tra_image_dir, tra_label_dir, cam_label_dir, cam_label_name, his_label_dir):
        ...
        his_1_lbl_name_list = [os.path.join(his_label_dir, "1", '{}_{}.bmp'.format(os.path.splitext(
            os.path.basename(img_path))[0], cam_label_name)) for img_path in tra_img_name_list]
        his_2_lbl_name_list = [os.path.join(his_label_dir, "2", '{}_{}.bmp'.format(os.path.splitext(
            os.path.basename(img_path))[0], cam_label_name)) for img_path in tra_img_name_list]

        Tools.print("train images: {}".format(len(tra_img_name_list)))
        Tools.print("train labels: {}".format(len(tra_lbl_name_list)))
        return tra_img_name_list, tra_lbl_name_list, cam_lbl_name_list, his_1_lbl_name_list, his_2_lbl_name_list
...
if __name__ == '__main__':
    ...
    Tools.print()
    _name_model = "CAM_123_SOD_{}_{}{}{}{}{}_DieDai3".format(
