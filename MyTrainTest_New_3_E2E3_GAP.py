...
class BASNet(nn.Module):
    ...
    def __init__(self, clustering_num=None, is_supervised_pre_train=False,
        ...
        self.mic_c2 = ConvBlock(2048, self.clustering_num, has_relu=False)
    ...
    def forward(self, x, has_mic=False, has_cam=False, has_sod=False):
        ...
        if has_mic:
            ...
            smc_logits = F.adaptive_avg_pool2d(mic_feature, output_size=(1, 1)).view((mic_feature.size()[0], -1))
            ...
            if has_cam:
                ...
                cam = self.cluster_activation_map_gap(smc_logits, mic_feature)  # 簇激活图
    ...
    @staticmethod
    def cluster_activation_map_gap(smc_logits, mic_feature):
        top_k_value, top_k_index = torch.topk(smc_logits, 1, 1)
...
def train(mic_batch_size, sod_batch_size):
    ...
    save_root_dir = "../BASNetTemp_E2E3_GAP/{}1".format(data_name_list[0])
